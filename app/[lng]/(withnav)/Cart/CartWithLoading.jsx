...
const CartWithLoading = () => {
 ...
 const handleUpdateQuantity = async (id, Quantity) => {
   ...
   try {
     ...
     console.log(err);
     addToast({ title: 'Failed to update quantity. Please try again.', type: 'error' });
   } finally {
 ...
 const handleRemoveItem = async (id) => {
   ...
   try {
     ...
     console.log(err);
     addToast({ title: 'Failed to remove item. Please try again.', type: 'error' });
   } finally {
     setLoadingStates(prev => ({ ...prev, [loadingKey]: false }));
   }
 }
...
export default CartWithLoading
